...
Reject any contract you can't verify mechanically. "Make it clean" is not an acceptance criterion. "`grep -c FILL skills/notees/` returns 0" is.
...
- [ ] Code quality per `skills/notees/rules/coding-standards.md`
