...
- `frontend/src/core/adapters/useInlineEditorAdapter.ts` — bridges the custom inline editor to `WorkspaceStore.updateText`, handling popup keepalive invariant from `../frontend.md`.
