...
**Spec:** `../superpowers/specs/2026-07-15-tasks-popup-design.md` (approved). Branch: `main`. Commits: one per task, Conventional Commits, stage only edited files (never `git add -A`).
...
Adjust token names to the ones actually used in `CalendarPopup.css` / the design tokens (`../design-language.md`); delete any token that doesn't exist in favor of the real one.
