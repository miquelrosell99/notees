...
- Profile project / 梳理项目 (`profile-project`) -> reads `architecture/index.md`; workflow `workflows/profile-project.md`; follow `workflows/profile-project.md`; write evidence-labeled conclusions; triggers: "refresh the project profile", "help me understand this codebase"
...
- Act on review feedback / 处理评审反馈 (`receive-review`) -> reads none; workflow `workflows/receiving-review.md`; follow `workflows/receiving-review.md`; verify each claim before changing code; triggers: "address the review comments", "the reviewer flagged this code", "apply PR review feedback"
- Update from upstream skill template / 从上游 skill 模板更新 (`update-upstream`) -> reads none; workflow `workflows/update-upstream.md`; follow `workflows/update-upstream.md`; triggers: "upstream skill template changed", "sync the skill from upstream"
