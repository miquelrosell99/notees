 ...
 * - Pill-style with small rounded corners and faded background
  ...
  return (
    <>
      ...
      >
        <Pill
          text={displayText}
          leftIcon={targetNode?.icon ? <NodeIcon icon={targetNode.icon} isPage={isPage} size="xs" /> : undefined}
          rightIcon={clickCount > 0 ? <span className="node-link__badge">{clickCount}</span> : undefined}
        />
      </span>
