...
export function ChildPagesSectionToolbar({
  ...
  return (
    <NodeCollectionToolbar
      ...
      showAddButton={true}
      onAdd={state.onAdd}
      selectedPropertyUuids={state.selectedPropertyUuids}
      onPropertyColumnsChange={state.onPropertyColumnsChange}
      className={className}
    />
  );
}
...
export function ChildPagesSection({ 
  ...
  return (
    <NodeCollection
      ...
      selectedPropertyUuids={toolbarState?.selectedPropertyUuids}
      onPropertyColumnsChange={toolbarState?.onPropertyColumnsChange}
    />
  );
}
