...
import { NodeNameContent } from '@/features/content';
import { NodeCellEditable } from '@/features/content';
      ...
      <Fragment key={key}>
        ...
        >
          ...
          {reorderable && currentDepth === depth && (
            <button
              type="button"
              className="table-drag-handle hover-reveal icon-only-touch-target"
