...
import { PageContextMenu, BlockContextMenu } from '../components/NodeContextMenu';
...
import { NodeActivityLog } from '../components/NodeActivityLog';
...
export function NodeView({ nodeId, nodeType, viewMode, compactMode = false }: NodeViewProps) {
  ...
  }, [node, createPage, addType, allTypes]);
