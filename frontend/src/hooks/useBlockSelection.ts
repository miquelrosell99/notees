...
function clearClasses(rootEl: HTMLElement): void {
...
function applyClasses(rootEl: HTMLElement, selectedIds: Set<string>): void {
  clearClasses(rootEl);
...
function updateSelectionOverlay(rootEl: HTMLElement, selectedEls: HTMLElement[]): void {
...
function getSiblingIds(blockId: string): string[] {
