...
from app.features.properties.router.classes import router as classes_router
from app.features.properties.router.crud import router as crud_router
from app.features.properties.router.selection_lines import router as selection_lines_router
