...
The server-side task automation engine was removed in Phase 8; status changes
and recurrence side effects are now client-emitted operations.  This module
only keeps the recurrence-rule description/computation helpers used by the
tasks router.
"""
