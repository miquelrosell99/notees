...
from app.domain.entities import NodeMention, NodeUpdateData
...
from app.features.nodes.link_service import LinkParsingService, generate_link_uuid

if TYPE_CHECKING:
    from app.domain.entities import Node
    from app.features.nodes.port import LinkRepository, MentionRepository, NodeRepository
