...
from .domain.repositories import PostgresUserRepository, PostgresWorkspaceRepository
from .domain.services.workspace_service import WorkspaceService, _active_workspaces
...
async def _get_service() -> WorkspaceService:
    ...
    return WorkspaceService(
        workspace_repo=PostgresWorkspaceRepository(pool),
