...
class NodeNotFoundError(NodeError):
    ...
    def __init__(self, node_id: str):
        ...
        super().__init__(message=f"Node not found: {node_id}", code="NODE_NOT_FOUND")
...
class DuplicateNodeError(NodeError):
    ...
    def __init__(self, name: str, conflicting_classes: list | None = None):
        self.name = name
        ...
        super().__init__(message=message, code="DUPLICATE_NODE")
...
class WorkspaceNotFoundError(WorkspaceError):
    ...
    def __init__(self, name: str):
        self.name = name
        super().__init__(message=f"Workspace not found: {name}", code="WORKSPACE_NOT_FOUND")
...
class DuplicateWorkspaceError(WorkspaceError):
    ...
    def __init__(self, name: str):
        self.name = name
        super().__init__(message=f"Workspace already exists: {name}", code="DUPLICATE_WORKSPACE")
