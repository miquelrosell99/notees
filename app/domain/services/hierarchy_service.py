...
"""
from typing import Optional, List, Set, Dict, Callable, Awaitable

from ..entities.node import Node, NodeId
from ..errors import (
...
class HierarchyService:
    ...
    def compute_path(
        node_id: NodeId,
        get_parent: Callable[[NodeId], Optional[NodeId]],
        max_depth: int = 100,
    ) -> List[NodeId]:
    ...
    def find_containing_page(
        node_id: NodeId,
        get_node: Callable[[NodeId], Optional[Node]],
        max_depth: int = 100,
    ) -> Optional[NodeId]:
