...
from ..repositories.interfaces import SyncRepository

if TYPE_CHECKING:
    from ...models import ClientNodeState, ServerNodeState, SyncConflict, SyncRequest, SyncResponse
...
class SyncService:
    ...
    async def sync(self, request: SyncRequest) -> SyncResponse:
        ...
        """
        from ...models import ServerNodeState, SyncConflict, SyncResponse
